...
def system():
     if inp == "":
         ...
         os.system("termux-telephony-call +917851065085")
     elif "light on" in inp:
         subprocess.call(["termux-tts-speak","on torch"])
         os.system("termux-torch on")
     elif "light off" in inp:
         subprocess.call(["termux-tts-speak","off torch"])
         os.system("termux-torch off")
         
     elif "YouTube" in inp:
         subprocess.call(["termux-tts-speak","open youtube"])
         os.system("termux-open https://m.youtube.com")
     elif "Google" in inp:
         subprocess.call(["termux-tts-speak","open google"])
         os.system("termux-open https://www.google.co.in/")

     elif "my house" in inp:
         subprocess.call(["termux-tts-speak","open google map"])
         os.system("termux-open https://www.google.com/maps/@26.8933742,75.7826463,47m/data=!3m1!1e3")    
